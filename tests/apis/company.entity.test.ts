...
describe('company.entity', () => {
  ...
  describe('对象不可变性', () => {
    ...
    it('CompanyDetail spread 保留 Company 基础字段', () => {
      const company: Company = {
    ...
    it('Object.freeze CompanyDetail operators 数组不可变', () => {
      const detail: CompanyDetail = {
        ...
        contact_person: 'C', contact_phone: 'D', status: true,
        created_at: new Date(), updated_at: new Date(), deleted_at: null,
        operator_ids: Object.freeze([1, 2]),
        operators: Object.freeze([{ id: 1, cn_name: 'OP' }]),
        viewer_ids: [], viewers: [],
      };
    ...
    it('rest spread 排除指定字段', () => {
      ...
      expect(Object.keys(rest)).toHaveLength(8);
  ...
  describe('跨接口一致性增强', () => {
    ...
    it('Company address (string|null) 与 CreateCompanyRequest (string|undefined) 兼容', () => {
      const req: CreateCompanyRequest = {
        short_name: 'A', full_name: 'B',
        contact_person: 'C', contact_phone: 'D',
        operator_ids: [1],
    ...
    it('UpdateCompanyRequest 继承 CreateCompanyRequest 的所有字段结构', () => {
      const createReq: CreateCompanyRequest = {
        short_name: 'A', full_name: 'B', address: 'C',
        contact_person: 'D', contact_phone: 'E',
        operator_ids: [1], viewer_ids: [2],
    ...
    it('CompanyDetail 在 Company 基础上增加恰好 4 个字段', () => {
      const companyKeys = ['id', 'short_name', 'full_name', 'address', 'contact_person',
        'contact_phone', 'status', 'created_at', 'updated_at', 'deleted_at'];
      const detail: CompanyDetail = {
        id: 1, short_name: 'A', full_name: 'B', address: null,
        contact_person: 'C', contact_phone: 'D', status: true,
        created_at: new Date(), updated_at: new Date(), deleted_at: null,
  ...
  describe('状态生命周期', () => {
    ...
    it('完整生命周期：创建 → 更新 → 停用 → 软删除', () => {
      ...
      const disabled_state: Company = {
        ...updated_state, status: false, updated_at: disabled_at,
      };
      ...
      const deleted_state: Company = {
        ...disabled_state, deleted_at, updated_at: deleted_at,
      };
  ...
  describe('类型推断与编译时安全', () => {
    ...
    it('Omit<Company, "deleted_at"> 排除 deleted_at', () => {
      ...
      expect(Object.keys(omitted)).toHaveLength(9);
    });
  });
